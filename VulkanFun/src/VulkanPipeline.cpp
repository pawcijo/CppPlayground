...
void VulkanPipeline::setupDebugMessenger()
{
  ...
  if (VulkanValidation::CreateDebugUtilsMessengerEXT(
...
void VulkanPipeline::createSwapChain()
{
  ...
  VkExtent2D extent =
    Utils::chooseSwapExtent(swapChainSupport.capabilities, &window);
...
void VulkanPipeline::createGraphicsPipeline()
{
  ...
  VkShaderModule vertShaderModule =
    Utils::createShaderModule(vertShaderCode, device);
  VkShaderModule fragShaderModule =
    Utils::createShaderModule(fragShaderCode, device);
...
void VulkanPipeline::createDepthResources()
{
  ...
  Utils::createImage(swapChainExtent.width,
...
void VulkanPipeline::createTextureImage()
{
  ...
  Utils::copyBufferToImage(stagingBuffer,
                           textureImage,
...
void VulkanPipeline::createIndexBuffer()
{
  ...
  Utils::copyBuffer(
    stagingBuffer, indexBuffer, bufferSize, commandPool, device, graphicsQueue);
